...
CREATE TABLE membre (
    ...
    wilaya VARCHAR(100),
    nin VARCHAR(18) UNIQUE NULL DEFAULT NULL,
...
('m1', 'Benali', 'Ahmed', 'ahmed@test.dz', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '0555000001', 'Alger', NULL, 'president_association', 'actif'),
('m2', 'Mansouri', 'Fatima', 'fatima@test.dz', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '0555000002', 'Oran', NULL, 'president_siege', 'actif'),
('m3', 'Khelil', 'Karim', 'karim@test.dz', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '0555000003', 'Constantine', NULL, 'membre_association', 'actif'),
('m4', 'Ouali', 'Sara', 'sara@test.dz', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '0555000004', 'Alger', NULL, 'membre', 'actif');
